...
if __name__ == "__main__":
    ...
    parser.add_argument("--train", type=str, dest="train_data", default=".", help="train data as input")
    parser.add_argument("--auxi", type=str, dest="auxi_data", default=".", help="auxi data as input")
    ...
    # Load training data
    default_train_file = os.path.join(TRAIN_DIR, "train.csv")
    ######## Get the train input dataset by ID
